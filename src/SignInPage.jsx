...
const SignInPage = () => {
  ...
  const handleSignIn = (e) => {
    ...
    alert('Sign in clicked — replace with auth logic');
  };
  ...
  return (
    <div style={{
      ...
      <form onSubmit={handleSignIn} style={{
        ...
        <h2 style={{ margin: 0, marginBottom: 16, fontSize: '1.6rem' }}>Sign In</h2>
        <p style={{ marginTop: 0, marginBottom: 18, color: 'rgba(255,255,255,0.85)' }}>
          Welcome back — sign in to access your EcoPulse dashboard.
        </p>
        ...
        <div style={{ marginTop: 14, fontSize: 13, color: 'rgba(255,255,255,0.75)', textAlign: 'center' }}>
          Don't have an account? <Link to="/signup" style={{ color: "rgba(255,255,255,0.95)", textDecoration: "underline" }}>
  Sign up
</Link>
